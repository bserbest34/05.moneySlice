...
public class BuyAreaUIManager : MonoBehaviour
{
    GManager gManager;
    public GameObject windowsAndPictureUI, couchUI, carpetUI, chairRightUI, chairLeftUI, lampUI, plantUI, tvUI;
    public GameObject[] buyableObjects;
    public int currentBoughtArea = 0;
    bool fullOpen = false;
    bool isClose = true;
